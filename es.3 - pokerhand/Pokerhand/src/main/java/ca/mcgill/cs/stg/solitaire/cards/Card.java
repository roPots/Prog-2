...
{
	// MODIFIED BY PROG2 ES
	public static final Comparator<Card> SUIT_THEN_RANK_COMPARATOR = Comparator.comparing((Card card) -> card.aSuit).thenComparing((Card card) -> card.aRank);
	public static final Comparator<Card> RANK_THEN_SUIT_COMPARATOR = Comparator.comparing((Card card) -> card.aRank).thenComparing((Card card) -> card.aSuit);
