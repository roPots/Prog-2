...
public class Main extends Application {
  ...
  // in generale si sarebbe potuta porre maggiore attenzione sul design by contract e la programmazione difensiva
  // esplicitando nullability di elementi, definendo assert e lanciando eccezioni per proteggere il programma da argomenti non gestibili
}
